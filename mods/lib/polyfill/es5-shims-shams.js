...
if (!Object.defineProperties) {
  Object.defineProperties = function (object, props) {
    ...
    if (Object(object) !== object) {
      throw new TypeError(
        "Object.defineProperties can only be called on Objects."
      );
    }
...
if (!Object.defineProperty) {
  Object.defineProperty = function defineProperty(
    ...
    if (Object(object) !== object) {
      throw new TypeError(
        "Object.defineProperty can only be called on Objects."
      );
    }
...
if (!Object.getOwnPropertyDescriptor) {
  Object.getOwnPropertyDescriptor = function getOwnPropertyDescriptor(
    ...
    if (Object(object) !== object) {
      throw new TypeError(
        "Object.getOwnPropertyDescriptor can only be called on Objects."
      );
    }
...
if (!Object.getOwnPropertyNames) {
  Object.getOwnPropertyNames = function getOwnPropertyNames(object) {
    if (Object(object) !== object) {
      throw new TypeError(
        "Object.getOwnPropertyNames can only be called on Objects."
      );
    }
    var names = [];
    ...
    for (var i = 0; i < all.length; i++) {
      ...
      if (
        ...
        !propertyIsEnumerable.call(object, prop)
      ) {
        names.push(prop);
      }
    }
...
if (!Object.getPrototypeOf) {
  Object.getPrototypeOf = function (object) {
    if (Object(object) !== object) {
      throw new TypeError(
        "Object.getPrototypeOf can only be called on Objects."
      );
    }
